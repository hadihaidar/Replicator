    ...
    $fileError = "";
      ...
      if ($fileActualExt!=='gcode' && $fileActualExt!=='g') {
       $fileError = "File must be of type: g or gcode";
        ...
        $ftp_username= '$replicator';
        $ftp_userpass="qfTW92j4MAvnin5MsFFP2hypFqt3Ca09zot8cM1M4SEWhBBAYnp3m51j9SQR";
    ...
    <div class="site-section bg-light">
      <div class="container">
        <div class="row">
          ...
          <form action="upload.php" class="p-5 bg-white" method="POST" enctype="multipart/form-data"> <!-- XSS(Cross Site Scripting) attacks HAHA-->
            <h1 class="mb-4">Adding A New Model</h1>
            ...
            <div class="row form-group">
              <div class="col-md-12">
                ...
                <input type="name" id="name" name ="name" class="form-control" value= "<?php  echo $name1; ?>" disabled>
