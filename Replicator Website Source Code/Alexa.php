       ...
       <div class="container">
         ...
         <div class="row">
           <div class="col-md-6 col-lg-6 mb-4" >
             <!--the mobile version looks bad with this iframe. make it responsive -->
             ...
             <h2 class="font-weight-bold text-uppercase display-3"><span class="d-block">Start The <div style="text-align:center;"> Replicator.</div></span> </h2> <br>
						 ...
						 <!-- <ul style = "margin-left: 50px">
							 <li></li>
							 	...
							 	<p>Kindly check the the screenshots below for an example of a Human-Alexa interaction. </p>
								 <!-- <a class="d-block mb-3 thumbnail"> <img src="images/cap1.jpeg" alt="Image" class="img-fluid"></a> -->
								<!-- <a class="d-block mb-3 thumbnail" > <img src="images/cap2.jpeg" alt="Image" class="img-fluid"></a>
                <a class="d-block mb-3 thumbnail" > <img src="images/cap3.jpeg" alt="Image" class="img-fluid"></a>  -->
           </div>

         </div>

       <a class="d-block mb-3 thumbnail"style="float:left;" > <img src="images/cap1.jpeg" alt="Image" class="img-fluid"></a>
         <a class="d-block mb-3 thumbnail" style="float:left;" > <img src="images/cap2.jpeg" alt="Image" class="img-fluid"></a>
           <a class="d-block mb-3 thumbnail"style="text-align:right;" ><img src="images/cap3.jpeg" alt="Image" class="img-fluid"></a>
       </div>
     </div>
    ...
    <div class="Launch" style="width:80%; margin:0 auto;">
      ...
      <p>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/__lAYgAYvgc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          ...
          <footer class="site-footer" style="background-image: url('images/alexa.jpg');">
            <div class="container">
              <div class="row">
                <div class="col-md-4">
