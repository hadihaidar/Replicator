      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-10 text-center" data-aos="fade">
            ...
            <a href="addModel.php" class="btn btn-primary px-4 py-3 text-uppercase">Upload Model</a>
        ...
        <div class="row">
          ...
          <div   class="col-md-4 col-lg-6">
            <div class="text-center p-4 item">
              ...
              <p> To check the list of available models, please go to the <a href="ourModels.php"> "Available Models" </a>section. You have to make sure your file is not there! After that, you can finally upload your files at <a href="addModel.php">"Upload Model"</a> and enjoy a universe of 3D printed models!</p>
            </div>
          </div>
